...
```bash
apt install curl -y curl -o install.sh https://raw.githubusercontent.com/<username>/<repo>/main/install.sh chmod +x install.sh dos2unix install.sh bash install.sh
```
